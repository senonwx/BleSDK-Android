...
public class HexUtils {
    ...
    public static int getBit(byte byData,int index) {
        if(index == 0) {
            return (byData & 0x01) == 0x01 ? 1 : 0;
        }else if(index == 1) {
            return (byData & 0x02) == 0x02 ? 1 : 0;
        }else if(index == 2) {
            return (byData & 0x04) == 0x04 ? 1 : 0;
        }else if(index == 3) {
            return (byData & 0x08) == 0x08 ? 1 : 0;
        }else if(index == 4) {
            return (byData & 0x10) == 0x10 ? 1 : 0;
        }else if(index == 5) {
            return (byData & 0x20) == 0x20 ? 1 : 0;
        }else if(index == 6) {
            return (byData & 0x40) == 0x40 ? 1 : 0;
        }else if(index == 7) {
            return (byData & 0x80) == 0x80 ? 1 : 0;
        }
        return 0;
    }
